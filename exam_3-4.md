...
\end{problem}
\Begin{solution}
Задача сводится к построению циркулем и линейкой числа $cbrt{2}$. Но $\Q(cbrt{2})$ — расширение степени 3 над $\Q$, поэтому не существует башни промежуточных расширений размерности 2.
