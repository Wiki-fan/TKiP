...
\begin{itemize}
\i у \(\Z[i]\) \(4k+3\)
\i у \(\Z[\omega]\) --- одно из следующих взаимоисключающих условий:
    \begin{itemize}
    \i $z$ является произведением обратимого элемента (например, 1) на натуральное простое вида \(3k+2\),
    \i $N(Z)^2 = a^2 - ab + b^2$ является натуральным простым, сравнимым с 0 или 1 по модулю 3.
	\end{itemize}
\end{itemize}
\end{solution}
